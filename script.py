...
def compile_contract(file_path, contract_name, evm_version="paris"):
    solc_version = '0.8.20'
    print(f"در حال کامپایل کردن {file_path} با solc نسخه {solc_version} و EVM نسخه {evm_version}...")
...
with open('networks.json', 'r') as f:
    ...
    evm_version = network_info.get('evm_version', 'paris')
...
try:
    ...
    if random_number % 2 == 0:
        ...
        token_abi, token_bytecode = compile_contract('contracts/MyToken.sol', 'MyToken', evm_version)
        ...
        nft_abi, nft_bytecode = compile_contract('contracts/MyNFT.sol', 'MyNFT', evm_version)
